...
export declare class NgxMatFileInputComponent extends _NgxMatInputMixinBase implements MatFormFieldControl<FileOrArrayFile>, OnDestroy, DoCheck, CanUpdateErrorState, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxMatFileInputComponent, "ngx-mat-file-input", ["ngx-mat-file-input"], { "color": "color"; "disabled": "disabled"; "id": "id"; "multiple": "multiple"; "placeholder": "placeholder"; "separator": "separator"; "required": "required"; "errorStateMatcher": "errorStateMatcher"; "value": "value"; "readonly": "readonly"; "accept": "accept"; }, {}, ["_customIcon"], ["[ngxMatFileInputIcon]"], false, never>;
}
export {};
